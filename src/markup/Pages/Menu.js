				...
				<div className="section-full bg-white">
							...
							<div className="menu-box">
								...
								<ul className="menu-list-2">
									...
									<li>
										...
										<h6>
											Choice of Sauce (Honey Mustard, Ranch, BBQ, Ketchup)
										</h6>
									</li>
									<li>
										<div className="info-price">
									...
									<li>
										...
										<h6>
											Tossed in hot or mild sauce with choice of Ranch or Blue
											Cheese
										</h6>
									</li>
									<li>
									...
									<li>
										<div className="info-price">
											<h5 className="title">
												Chicken Tenders & Fries Combo (3pc)
											</h5>
											<div className="line"></div>
									...
									<li>
										<div className="info-price">
											<h5 className="title">
												Chicken Tenders & Fries Combo (5pc)
											</h5>
											<div className="line"></div>
									...
									<li>
										<div className="info-price">
											<h5 className="title">
												Buffalo Chicken Tenders & Fries Combo (3pc)
											</h5>
											<div className="line"></div>
									...
									<li>
										<div className="info-price">
											<h5 className="title">
												Buffalo Chicken Tenders & Fries Combo (5pc)
											</h5>
											<div className="line"></div>
					...
					<div className="row sp0">
						<div className="col-lg-6">
							<img
								src={wings}
								alt="by Erik Mclean on Unsplash"
								className="img-cover"
							/>
						</div>
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										...
										<br />
										Served with Celery & Bleu Cheese or Ranch
									</p>
								</div>
								<ul className="menu-list-2">
									<li>
						...
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										<b>Dressings:</b> Ranch, Italian, Bleu Cheese, Honey
										Mustard, Caesars, Balsamic Vinaigrette, Oil & Vinegar or
										Thousand Island
									</p>
								</div>
								<ul className="menu-list-2">
									<li>
										...
										<p>
											Crispy romaine lettuce, house made croutons and Parmesan
											cheese
										</p>
									</li>
									<li>
										...
										<p>
											Our Caesar salad topped with fresh marinated, grilled
											chicken
										</p>
									</li>
									<li>
										...
										<p>
											Mixed greens, tomato, onion, roasted peppers, croutons,
									...
									<li>
										...
										<p>
											Our garden salad with chicken tenders tossed with hot
											sauce
										</p>
									</li>
									<li>
										...
										<p>
											{' '}
											Our garden salad with ham, turkey, provolone and american
											cheese
										</p>
									</li>
									<li>
										...
										<p>
											Our garden salad with a scoop of our homemade tuna salad
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											{' '}
											Our garden salad with a scoop of our homemade chicken
											salad
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Our garden salad with crispy chicken tenders & american
											cheese
										</p>
									</li>
								</ul>
						...
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										<b>Pick a Tortilla</b> - White, Whole Wheat, Sun Dried
										Tomato, Spinach
										<br />
										<b>Pick a Spread</b> - Mayo, Southwest Spread, Mustard,
										Spicy Mustard, Honey Mustard, Ranch, Hot Sauce, Humus
										<br />
										<b>Pick a Protein</b> - Grilled Chicken, Roast Beef, Chicken
										Salad, Tuna Salad, Turkey, Ham, Chicken Tenders
										<br />
										<b>Pick 1 Cheese</b> - american, provolone, swiss, cheddar,
										wiz, mozzerella, pepperJack
										<br />
										<b>Pick Your Veggies</b> - Lettuce, Tomato, Onion, Roasted
										Peppers, Mushroom, Hot Peppers, Sweet Pepper, Pickle, Cole
										Slaw
										<br />
								...
								<ul className="menu-list-2">
									<li>
										...
										<p>
											Pulled Pork, Black Forrest Ham, cheese, pickles, mustard,
											ham and swiss
										</p>
									</li>
									<li>
										...
										<p>
											Southwest Spread, turkey, lettuce, sweet peppers and
									...
									<li>
										...
										<p>
											Chicken tenders tossed in hot sauce with lettuce, tomato,
											and blue cheese or ranch
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											spring mix, kalamata olives, roasted peppers, tomato, feta
											cheese, onion, lettuce, oregano, oil and vinegar
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											Sliced turkey, crispy bacon, lettuce, tomato, and mayo
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											crisp romaine lettuce, grilled chicken, ceasar dressing
											and parmesan cheese
										</p>
									</li>
								</ul>
							...
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										...
										<br />
										• Grilled Chicken • Roast Beef Turkey • Tuna Salad • Chicken
										Salad • Ham & Cheese <br />
										Add Cheese $1
									</p>
									<h2 className="title">Best Sellers</h2>
							...
							<div className="menu-box">
								...
								<ul className="menu-list-2">
									<li>
										...
										<p>
											beef steak, chicken steak, bacon, american cheese, all
											mixed together
										</p>
									</li>
									<li>
										...
										<p>
											hot sauce and american cheese with blue cheese or ranch
										</p>
									</li>
									<li>
										<div className="info-price">
									...
									<li>
										...
										<p>
											beef steak mixed with marinara sauce & mozzerella cheese
										</p>
									</li>
								</ul>
							</div>
							...
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										...
										<br />
										<b>PICK A PATTY</b> - Short Rib Beef Angus, Fried Chicken
										Cutlet, Turkey Burger or Veggie Burger
										<br />
										<b>PICK A CHEESE</b> - American, Provolone, Swiss, Cheddar,
										Wiz, Mozzarella
										<br />
										<b>PICK YOUR SPREADS</b> - Ketchup, Mayo, Southwest Spread,
										Mustard, Spicy Mustard
										<br />
										<b>PICK YOUR VEGGIES</b> - Lettuce, Tomato, Fried Onion, Raw
										Onion, Roasted Peppers, Mushroom, Pickle, Cole Slaw, Relish,
								...
								<ul className="menu-list-2">
									<li>
										...
										<p>
											Fried onions, lettuce, tomato, thousand island dressing,
											on a grilled cheese
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Fried chicken cutlet, cole slaw, southwest spread on a
											grilled brioche bun
										</p>
									</li>
									<li>
										...
										<p>
											Turkey Burger with southwest sauce, crispy torilla chips,
											sweet peppers on a grilled brioche bun
										</p>
									</li>
								</ul>
							</div>
							...
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										...
										<br />
										<b>PICK 1 PROTEIN</b> - turkey, ham, roast beef, tuna salad,
										chicken salad, grilled chicken, chicken tenders
										<br />
										<b>PICK 1 CHEESE</b> - american, provolone, swiss, cheddar,
										mozzarella, pepperjack PICK YOUR SPREADS - mayo, southwest
										spread, mustard, spicy mustard, honey mustard, oil, vinegar,
										ranch <br />
										<b>Pick a Spread</b> - Mayo, Southwest Spread, Mustard,
										Spicy Mustard, Honey Mustard, Ranch, Hot Sauce, Humus
										<br />
								...
								<ul className="menu-list-2">
									<li>
										...
										<p>
											Black Forest Ham, Capicola, Genoa Salami, Provolone,
											lettuce, tomato, onion, oil or mayo
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											lettuce, tomato, hot sauce and choice of ranch or blue
											cheese
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Chicken tenders, honey mustard, American cheese, lettuce
											and tomato
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Pulled Pork, Black Forest ham, Swiss cheese, pickles and
											mustard
										</p>
									</li>
								</ul>
						...
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										<b>
											Served On Your choice Of White, Wheat, Rye Bread or a
											Brioche Bun
										</b>
										<br />
										<b>PICK 1 PROTEIN</b> - turkey, ham, roast beef, tuna salad,
										chicken salad, grilled chicken breast, chicken tender
										<br />
										<b>PICK 1 CHEESE</b> - american, provolone, swiss, cheddar,
										mozzarella, pepperjack <br />
										<b>PICK YOUR SPREADS</b> - mayo, southwest spread, mustard,
										spicy mustard, honey mustard, oil, vinegar, ranch <br />
										<b>PICK YOUR VEGGIES</b> - lettuce, tomato, onion, roasted
										peppers. sweet pepper, hot pepper, pickle, cole slaw
									</p>
									<h2 className="title">Best Sellers</h2>
								...
								<ul className="menu-list-2">
									...
									<li>
										...
										<p>
											Chicken Salad on a brioche bun with crispy bacon and
											American cheese
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Slow roasted pork with long hot peppers & Provolone cheeze
									...
									<li>
										...
										<p>
											Chicken, Bacon & PepperJack cheese with Ranch dressing
									...
									<li>
										...
										<p>
											On a brioche bun with honey mustard, crispy bacon,
									...
									<li>
										...
										<p>
											Open face on rye with tomato, swiss cheese, Thousand
											Island dressing
										</p>
									</li>
								</ul>
							...
							<div className="menu-box">
								<div className="section-head style-2">
									...
									<p>
										...
										<b>PICK 1 PROTEIN</b> - turkey, ham, bacon, roast beef{' '}
										<br />
										<b>PICK 1 CHEESE</b> - american, provolone, swiss, cheddar,
										mozzarella, pepperjack <br />
										<b>PICK YOUR SPREADS</b> - mayo, southwest spread, mustard,
							...
							<div className="menu-box">
								...
								<ul className="menu-list-2">
									<li>
										...
										<p>
											Cheesesteak, Chicken Cheesesteak, Tiger Steak, Buffalo
									...
									<li>
										...
										<p>
											Southwest Turkey, Itailian, Chicken Salad, Cuban, Buffalo
											Tender, Tuna, Chicken Caesar, Turkey BLT, Ham, Roast Beef,
											Mediterranean
										</p>
									</li>
									<li>
										...
										<p>
											Ham and Cheese, Turkey, Roast Beef, Chicken Salad, Tuna,
											Mixed Cheese, Buffalo Chicken Tender, Southwest Turky,
											Turkey BLT
										</p>
									</li>
									<li>
										...
										<p>
											Turkey, Ham, Chicken Salad, Tuna, Roast Beef, Mixed
											Cheese, Chumpy, Drizzle, Italian
										</p>
									</li>
									<li>
										<div className="info-price">
										...
										<p>
											crisp romain with croutons parmesan cheese and dressing on
											the side
										</p>
